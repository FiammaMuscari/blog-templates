...
Una clase debe estar abierta para la extensión pero cerrada para la modificación. Es como tener una caja de herramientas donde puedes agregar nuevas herramientas sin necesidad de cambiar las que ya tenes. (Open/Closed Principle)
